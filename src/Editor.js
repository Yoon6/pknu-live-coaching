    ...
    <div>
      <header className="p-4 shadow-sm">
        <div className="inline-block text-lg">
          <h1>PKNU LIVE COACHING</h1>
        </div>
      </header>
      <div className="flex">
        <div className="flex-auto w-1/5 card m-2 cursor-pointer border border-gray-400 rounded-lg ">
          <div className="m-3">
            <h2 className="text-lg mb-2 font-semibold">
              Current Dir : {context.username}/
            </h2>
          </div>
        ...
        <div className="m-2 flex-auto w-full">
          ...
          />
          <button className="py-2 px-4 block rounded-lg shadow-md text-white bg-blue-600 m-auto hover:bg-blue-800">
            Compile
          </button>
        </div>
      </div>
